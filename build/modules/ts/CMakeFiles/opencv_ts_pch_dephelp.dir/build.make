...
modules/ts/opencv_ts_pch_dephelp.cxx: ../modules/ts/src/precomp.hpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/data/opencv-2.4.13.6/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating opencv_ts_pch_dephelp.cxx"
	cd /data/opencv-2.4.13.6/build/modules/ts && /usr/bin/cmake -E echo \#include\ \"/data/opencv-2.4.13.6/modules/ts/src/precomp.hpp\" > /data/opencv-2.4.13.6/build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/ts && /usr/bin/cmake -E echo int\ testfunction\(\)\; >> /data/opencv-2.4.13.6/build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/ts && /usr/bin/cmake -E echo int\ testfunction\(\) >> /data/opencv-2.4.13.6/build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/ts && /usr/bin/cmake -E echo { >> /data/opencv-2.4.13.6/build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/ts && /usr/bin/cmake -E echo \ \ \ \ \return\ 0\; >> /data/opencv-2.4.13.6/build/modules/ts/opencv_ts_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/ts && /usr/bin/cmake -E echo } >> /data/opencv-2.4.13.6/build/modules/ts/opencv_ts_pch_dephelp.cxx
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.o: modules/ts/opencv_ts_pch_dephelp.cxx
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/data/opencv-2.4.13.6/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.o"
	cd /data/opencv-2.4.13.6/build/modules/ts && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.o -c /data/opencv-2.4.13.6/build/modules/ts/opencv_ts_pch_dephelp.cxx
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.i: cmake_force
	...
	cd /data/opencv-2.4.13.6/build/modules/ts && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /data/opencv-2.4.13.6/build/modules/ts/opencv_ts_pch_dephelp.cxx > CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.i
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.s: cmake_force
	...
	cd /data/opencv-2.4.13.6/build/modules/ts && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /data/opencv-2.4.13.6/build/modules/ts/opencv_ts_pch_dephelp.cxx -o CMakeFiles/opencv_ts_pch_dephelp.dir/opencv_ts_pch_dephelp.cxx.s
...
lib/libopencv_ts_pch_dephelp.a: modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/data/opencv-2.4.13.6/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ../../lib/libopencv_ts_pch_dephelp.a"
	cd /data/opencv-2.4.13.6/build/modules/ts && $(CMAKE_COMMAND) -P CMakeFiles/opencv_ts_pch_dephelp.dir/cmake_clean_target.cmake
	cd /data/opencv-2.4.13.6/build/modules/ts && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/opencv_ts_pch_dephelp.dir/link.txt --verbose=$(VERBOSE)
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/clean:
	cd /data/opencv-2.4.13.6/build/modules/ts && $(CMAKE_COMMAND) -P CMakeFiles/opencv_ts_pch_dephelp.dir/cmake_clean.cmake
...
modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/depend: modules/ts/opencv_ts_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /data/opencv-2.4.13.6 /data/opencv-2.4.13.6/modules/ts /data/opencv-2.4.13.6/build /data/opencv-2.4.13.6/build/modules/ts /data/opencv-2.4.13.6/build/modules/ts/CMakeFiles/opencv_ts_pch_dephelp.dir/DependInfo.cmake --color=$(COLOR)
