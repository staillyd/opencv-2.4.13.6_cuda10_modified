...
modules/legacy/opencv_legacy_pch_dephelp.cxx: ../modules/legacy/src/precomp.hpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/data/opencv-2.4.13.6/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating opencv_legacy_pch_dephelp.cxx"
	cd /data/opencv-2.4.13.6/build/modules/legacy && /usr/bin/cmake -E echo \#include\ \"/data/opencv-2.4.13.6/modules/legacy/src/precomp.hpp\" > /data/opencv-2.4.13.6/build/modules/legacy/opencv_legacy_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/legacy && /usr/bin/cmake -E echo int\ testfunction\(\)\; >> /data/opencv-2.4.13.6/build/modules/legacy/opencv_legacy_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/legacy && /usr/bin/cmake -E echo int\ testfunction\(\) >> /data/opencv-2.4.13.6/build/modules/legacy/opencv_legacy_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/legacy && /usr/bin/cmake -E echo { >> /data/opencv-2.4.13.6/build/modules/legacy/opencv_legacy_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/legacy && /usr/bin/cmake -E echo \ \ \ \ \return\ 0\; >> /data/opencv-2.4.13.6/build/modules/legacy/opencv_legacy_pch_dephelp.cxx
	cd /data/opencv-2.4.13.6/build/modules/legacy && /usr/bin/cmake -E echo } >> /data/opencv-2.4.13.6/build/modules/legacy/opencv_legacy_pch_dephelp.cxx
...
modules/legacy/CMakeFiles/opencv_legacy_pch_dephelp.dir/opencv_legacy_pch_dephelp.cxx.o: modules/legacy/opencv_legacy_pch_dephelp.cxx
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/data/opencv-2.4.13.6/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Building CXX object modules/legacy/CMakeFiles/opencv_legacy_pch_dephelp.dir/opencv_legacy_pch_dephelp.cxx.o"
	cd /data/opencv-2.4.13.6/build/modules/legacy && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/opencv_legacy_pch_dephelp.dir/opencv_legacy_pch_dephelp.cxx.o -c /data/opencv-2.4.13.6/build/modules/legacy/opencv_legacy_pch_dephelp.cxx
...
modules/legacy/CMakeFiles/opencv_legacy_pch_dephelp.dir/opencv_legacy_pch_dephelp.cxx.i: cmake_force
	...
	cd /data/opencv-2.4.13.6/build/modules/legacy && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /data/opencv-2.4.13.6/build/modules/legacy/opencv_legacy_pch_dephelp.cxx > CMakeFiles/opencv_legacy_pch_dephelp.dir/opencv_legacy_pch_dephelp.cxx.i
...
modules/legacy/CMakeFiles/opencv_legacy_pch_dephelp.dir/opencv_legacy_pch_dephelp.cxx.s: cmake_force
	...
	cd /data/opencv-2.4.13.6/build/modules/legacy && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /data/opencv-2.4.13.6/build/modules/legacy/opencv_legacy_pch_dephelp.cxx -o CMakeFiles/opencv_legacy_pch_dephelp.dir/opencv_legacy_pch_dephelp.cxx.s
...
lib/libopencv_legacy_pch_dephelp.a: modules/legacy/CMakeFiles/opencv_legacy_pch_dephelp.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/data/opencv-2.4.13.6/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Linking CXX static library ../../lib/libopencv_legacy_pch_dephelp.a"
	cd /data/opencv-2.4.13.6/build/modules/legacy && $(CMAKE_COMMAND) -P CMakeFiles/opencv_legacy_pch_dephelp.dir/cmake_clean_target.cmake
	cd /data/opencv-2.4.13.6/build/modules/legacy && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/opencv_legacy_pch_dephelp.dir/link.txt --verbose=$(VERBOSE)
...
modules/legacy/CMakeFiles/opencv_legacy_pch_dephelp.dir/clean:
	cd /data/opencv-2.4.13.6/build/modules/legacy && $(CMAKE_COMMAND) -P CMakeFiles/opencv_legacy_pch_dephelp.dir/cmake_clean.cmake
